    ...
    Try {
      ...
      for (cell <- cellNodes) {
        ...
        if ((cell \\ "piece" \ "@color").text == "None") {
          ...
          if ((cell \\ "piece" \ "@color").text == "black") {
            pieceColor = Color.black
          }
          if ((cell \\ "piece" \ "@queen").text == "isQueen") {
            queen = Queen.isQueen
          }
          if ((cell \\ "piece" \ "@kicked").text == "isKicked") {
            kicked = Kicked.isKicked
          }
      ...
      for (piece <- pieceNodesBlack) {
        ...
        var queen: Queen.Value = Queen.notQueen
        var kicked: Kicked.Value = Kicked.notKicked
        if ((piece \\ "@queen").text == "isQueen") {
          queen = Queen.isQueen
        }
        if ((piece \\ "@kicked").text == "isKicked") {
          kicked = Kicked.isKicked
        }
      ...
      if ((file \\ "game" \\ "lmc" \ "@color").text == "black") {
        lmc = Color.black
      }
      if ((file \\ "game" \\ "winnerColor" \ "@color").text == "black") {
        winnerColor = Some(Color.black)
      }
      else if ((file \\ "game" \\ "winnerColor" \ "@color").text == "white") {
        winnerColor = Some(Color.white)
      }
